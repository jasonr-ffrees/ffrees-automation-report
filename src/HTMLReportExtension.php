...
class HTMLReportExtension implements ExtensionInterface
{
    /**
    ...
    {
        $builder->children()->scalarNode("name")->defaultValue("jroyhtml");
    ...
    {
        $definition = new Definition("jroy\\HTMLReport\\Formatter\\HTMLFormatter");
